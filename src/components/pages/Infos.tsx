            ...
            <div>
              <div className="flex">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-3xl">
                    Préparez-vous à plonger dans l'horreur... mais assurez-vous
                    de ne pas arriver trop tard, les zombies n'attendent
                    personne !
                  </p>
                </div>
              </div>
              <div className="flex justify-center items-center md:ml-20 mb-10">
                <ul className="mt-8">
                  ...
                  <li className="flex items-center mb-6">
                    <img src={skullImg} alt="icone crane" />
                    <p className="text-3xl ml-8">
                      <em className="text-redZombie">Samedi</em> : 10h00 -
                      minuit (les zombies sont plus affamés le week-end...)
                    </p>
                  </li>
                  <li className="flex items-center mb-6">
                    <img src={skullImg} alt="icone crane" />
                    <p className="text-3xl ml-8">
                      <em className="text-redZombie">Dimanche</em> : 10h00 -
                      20h00 (on ferme tôt, même les morts-vivants ont besoin de
                      repos !)
                    </p>
                  </li>
                  <li className="flex items-center mb-6">
                    ...
                    <p className="text-3xl ml-8">
                      <em className="text-redZombie">
                        Nocturnes Apocalyptiques
                      </em>{' '}
                      : Tous les derniers vendredis du mois, le parc reste
                      ouvert jusqu'à 02h00 du matin pour une expérience
                      terrifiante à la lumière de la lune.
                    </p>
                  </li>
                  <li className="flex items-center mb-6">
                    <img src={skullImg} alt="icone crane" />
